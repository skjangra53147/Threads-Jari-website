...
export default function Testimonials() {
  ...
  return (
    <div>
      {/* ── HEADER ── */}
      <section className="testimonials-header relative overflow-hidden bg-[url('/public/images/image15.png')] bg-cover bg-center bg-no-repeat px-4 py-10 sm:py-12 md:py-14">
