...
export default function PrivacyPolicy() {
  return (
    <div>
      {/* ── HEADER ── */}
      <section className="privacy-header relative overflow-hidden bg-[url('/public/images/image7.png')] bg-cover bg-center bg-no-repeat px-4 py-10 sm:py-12 md:py-14">
